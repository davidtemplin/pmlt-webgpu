class UpdateChainKernel {
    ...
    initialize(params) {
        const module = params.device.createShaderModule({
            label: 'update_chain module',
            code: UPDATE_CHAIN_CODE,
        });

        this.#pipeline = params.device.createComputePipeline({
            label: 'update_chain compute pipeline',
    ...
    encode(params) {
        ...
        const buffer = params.device.createBuffer({
            label: 'update_chain uniforms buffer',
        ...
        const bindGroup = params.device.createBindGroup({
            label: 'update_chain uniforms bind group',
